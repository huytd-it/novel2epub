...
Khi `model_id` chứa `HachimiMT`, `MoxhiMTTranslator` SHALL tự động áp dụng các tham số tối ưu (beam_size=2, max_input_tokens=160, ct2_subdir="ct2-int8_float32") nếu user chưa override rõ ràng trong config.
...
- **THEN** model load với beam_size=2, ct2_max_input_tokens=160, ct2_subdir="ct2-int8_float32"
