...
LUẬT CỐT LÕI:
- Đầu ra phải là tiếng Việt 100% — dịch TOÀN BỘ, không để lại ký tự Trung Quốc (Chinese characters) nào.
- KHÔNG dùng kiểu "từ gốc (dịch nghĩa)" hay chú thích song ngữ.
- Từ khó, không chắc nghĩa: chọn từ tiếng Việt gần nghĩa nhất theo ngữ cảnh — thà dịch thoát ý còn hơn giữ ký tự Trung Quốc.

Luật dịch:
1. Dịch tự nhiên, đúng ngữ pháp Việt Nam.
2. Tên riêng, công pháp, địa danh giữ Sino-Vietnamese (Hán Việt).
...
6. Từ đời thường (động tác, nấu nướng, ăn uống, cảm giác...) dịch tự nhiên như văn nói tiếng Việt, không phiên âm Sino-Vietnamese cứng nhắc.
