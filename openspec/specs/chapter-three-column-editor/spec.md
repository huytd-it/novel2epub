# Spec: chapter-three-column-editor

## Purpose

Trang chương trong web UI trình bày bản gốc, bản dịch máy, và bản biên tập
cuối cùng song song trong 3 cột riêng biệt, giúp người biên tập đối chiếu
trực tiếp bản dịch máy với bản gốc khi sửa tay hoặc chạy biên tập AI, đồng
thời giữ snapshot bản dịch máy độc lập với bản biên tập (`translated`) dùng
để build EPUB.
