# Spec: nmt-default-config

## Purpose

Đặt NMT (MoxhiMT/HachimiMT) làm translate backend mặc định thay vì OpenAI. Cả hai model chạy offline, miễn phí, tối ưu cho tiểu thuyết mạng zh→vi. Thêm batch title translation để dịch toàn bộ TOC trong 1 lần gọi model.
